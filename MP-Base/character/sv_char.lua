...
AddEventHandler('MP-Base:server:createCharacter', function(cData)
    ...
    MySQL.query('INSERT INTO players (`identifier`, `license`, `name`, `cid`, `cash`, `bank`, `firstname`, `lastname`, `sex`, `dob`, `phone`, `bankingID`, `citizenid`) VALUES (@identifier, @license, @name, @cid, @cash, @bank, @firstname, @lastname, @sex, @dob, @phone, @bankingId, @citizenid)', {
