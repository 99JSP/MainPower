    ...
    while true do
        ...
        if IsEntityDead(playerPed) and not alreadyDead then
            ...
            if checkArray (Melee, death) then
                TriggerServerEvent('playerDied', killername .. " Steam Ident = " ..  GetPlayerIdentifiers(killername)[1] .. " meleed " .. playerName .. "Steam Ident = " .. GetPlayerIdentifiers(playerName)[1])
            elseif checkArray (Bullet, death) then
                TriggerServerEvent('playerDied', killername ..  " Steam Ident = " ..  GetPlayerIdentifiers(killername)[1] .. " shot " .. playerName .. "Steam Ident = " .. GetPlayerIdentifiers(playerName)[1])
            elseif checkArray (Knife, death) then
                TriggerServerEvent('playerDied', killername ..  " Steam Ident = " ..  GetPlayerIdentifiers(killername)[1] .. " stabbed " .. playerName .. "Steam Ident = " .. GetPlayerIdentifiers(playerName)[1])
            elseif checkArray (Car, death) then
                TriggerServerEvent('playerDied', killername ..  " Steam Ident = " ..  GetPlayerIdentifiers(killername)[1] .. " hit " .. playerName .. "Steam Ident = " .. GetPlayerIdentifiers(playerName)[1])
