...
RegisterNetEvent('MP:Client:OnPlayerUnload', onLogout)

RegisterNetEvent('MP:Player:SetPlayerData', function(data)
...
function client.setPlayerStatus(values)
	for name, value in pairs(values) do
		...
		-- if name == "hunger" then
		-- 	TriggerServerEvent('consumables:server:addHunger', MP.Functions.GetPlayerData().metadata.hunger + value)
		-- elseif name == "thirst" then
		-- 	TriggerServerEvent('consumables:server:addThirst', MP.Functions.GetPlayerData().metadata.thirst + value)
